...
import com.mpd.pmdm.practicaroommodulos.databinding.FragmentItemListModuloBinding
...
class ModulesListFragment : Fragment() {
    private var _binding: FragmentItemListModuloBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentItemListModuloBinding.inflate(inflater, container, false)
        return binding.root
    }
